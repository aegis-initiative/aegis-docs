...
SITE_ROOT = "sites/docs"
RELEASES_ROOT = f"{SITE_ROOT}/src/content/docs/releases"
...
def update_index(year, month, tag, summary):
    ...
    index_path = f"{RELEASES_ROOT}/index.md"
...
def main():
    ...
    daily_path = f"{RELEASES_ROOT}/{year}/{month}/{day}.md"
